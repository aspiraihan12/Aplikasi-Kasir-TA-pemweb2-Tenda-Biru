...
class UserController extends Controller
{
    ...
    {
        // Kode yang ingin Anda jalankan saat sesi berakhir
        // Misalnya, membersihkan atau menyimpan data tambahan

        // Contoh: Menyimpan data log saat sesi berakhir
        // $user = auth()->user();
        // Log::info('Sesi pengguna berakhir: ' . $user->name);
        ...
        return redirect()->route('login')->with('success', 'Session has been terminated.');
    }
}
